...
class AuthController extends Controller
{
    ...
    */
    ...
    {
        $company = Company::selectRaw('company_id,company_name')->get();
        return view('auth.register',['company'=>$company]);
    }

    public function getCompanyInfo(Request $request){
        $companyinfo = Company::where('company_id',$request->companyid)->first();
        return new JsonResponse($companyinfo,200);
    }
