							...
							<div class="goodsInfo">
								@if(isset($value['pro_unitPrice']))
									@if($value['pro_unitPrice'] != 0)
										<div class="priceNow">
											<span class="now">￥<span>{{$value['pro_unitPrice']}}</span></span><span class="price"><span>{{isset($value['wholesale_unit'])?'/'.$value['wholesale_unit']:""}}</span></span>
										</div>
										<div class="regularPrice ">
											...
											{{--@if(isset($value['pro_regularPrice']))--}}
												{{--@if($value['pro_regularPrice']!=0)--}}
													{{--<span class="proUnitPrice"><span>{{$value['pro_unitPrice']}}</span><span></span></span>--}}
												{{--@else--}}
