                                ...
                                @foreach($value['products'] as $k => $v)
                                    <div class="goods" onclick="window.location.href='{{url('product/item?companyid='.$value['company_id'].'&proid='.$v['pro_id'])}}'">
                                        ...
                                        <div class="shadow">
                                            ...
                                            <div class="standard">{{isset($v['pro_packing'])&&$v['pro_packing']?'包装规格:'.$v['pro_packing']:""}}</div>
                                            <div class="origin">{{isset($v['pro_place'])?'产地:'.$v['pro_place']:""}}</div>
                                        </div>
                                        @if(isset($v['pro_unitPrice']))
                                            @if($v['pro_unitPrice']!=0)
                                                <div class="price"><span>￥</span><span>{{isset($v['pro_unitPrice'])?$v['pro_unitPrice'].'/'.$v['wholesale_unit']:""}}</span></div>
                                            @else
                                                <div class="price">
